...
public class EvaluationCriteriaController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<EvaluationCriteriaResponseDTO>> saveEvaluationCriteria(@RequestBody EvaluationCriteriaRequestDTO list) {
        EvaluationCriteriaResponseDTO response = evaluationCriteriaService.saveEvaluationCriteria(list);
