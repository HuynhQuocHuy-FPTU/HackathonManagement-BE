...
public class EvaluationCriteriaServiceImpl implements EvaluationCriteriaService {
    ...
    @Override
    @Transactional
    public EvaluationCriteriaReponseDTO saveEvaluationCriteria(EvaluationCriteriaRequestDTO request) {
        ...
        if (request.getCriteriaList() != null && !request.getCriteriaList().isEmpty()) {
            ...
            for (EvaluationCriteriaRequestDTO.CriteriaCustomDTO dto : request.getCriteriaList()) {
        ...
        // 4. Build response
        EvaluationCriteriaReponseDTO response = new EvaluationCriteriaReponseDTO();
        ...
        // 5. Map items
        List<EvaluationCriteriaReponseDTO.EvaluationItemResponseDTO> itemList =
                new ArrayList<>();

        for (EvaluationCriteria entity : savedList) {

            EvaluationCriteriaReponseDTO.EvaluationItemResponseDTO item =
                    new EvaluationCriteriaReponseDTO.EvaluationItemResponseDTO();
    ...
    @Override
    public EvaluationCriteriaReponseDTO getByEventId(Integer eventId) {
        return null;
    }
    ...
    public void updateEvaluationCriteria(EvaluationCriteriaRequestDTO evaluationCriteriaRequestDTO) {
        ...
        for (EvaluationCriteriaRequestDTO.CriteriaCustomDTO dto : evaluationCriteriaRequestDTO.getCriteriaList()) {
            if (dto.getEvaluationCriteriaId() == null) {
